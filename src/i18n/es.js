export default {
  ...
  projects: {
    lolocal: {
      title: 'LoLocal',
      desc: 'App de marketplace para compra-venta local.',
      tags: ['UX/UI', 'Research'],
    },
    remitly: {
      title: 'Remitly',
      desc: 'Rediseño de flujos de la app fintech Remitly.',
      tags: ['UX/UI', 'Research'],
    },
    pedidosya: {
      title: 'PedidosYA',
      desc: 'Nueva funcionalidad para plataforma de delivery.',
      tags: ['UX/UI', 'Research'],
    },
    tlp: {
      title: 'Telepianxs',
      desc: 'Onboarding para comunidad de salud mental.',
      tags: ['UX/UI', 'Research'],
    },
    cactus: {
    ...
    portfolio: {
      ...
      desc: 'De una plantilla estándar a una identidad editorial propia.',
